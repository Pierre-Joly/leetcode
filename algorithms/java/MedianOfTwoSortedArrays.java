...
public class Solution {
    public double findMedianSortedArrays(int[] nums1, int[] nums2) {
        int[] Nums1 = (nums1.length <= nums2.length) ? nums1 : nums2 ;
        int[] Nums2 = (nums1.length <= nums2.length) ? nums2 : nums1 ;
        ...
        throw new IllegalArgumentException("No valid partition found");
    }
}
